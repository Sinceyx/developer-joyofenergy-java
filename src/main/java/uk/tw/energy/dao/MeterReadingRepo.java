...
public interface MeterReadingRepo extends JpaRepository<MeterReadingPo, Id> {
    ...
    List<MeterReadingPo> findBySmartMeterId(String smartMeterId) ;
    ...
    List<MeterReadingPo> findBySmartMeterIdAndTimeBetween(@Param("smartMeterId") String smartMeterId, @Param("startTime") Instant startTime, @Param("endTime") Instant endTime);
